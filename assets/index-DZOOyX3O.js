 ...
 */var xd;function xp(){if(xd)return On;xd=1;var f=Symbol.for("react.transitional.element"),u=Symbol.for("react.fragment");function c(s,d,h){var m=null;if(h!==void 0&&(m=""+h),d.key!==void 0&&(m=""+d.key),"key"in d){h={};for(var S in d)S!=="key"&&(h[S]=d[S])}else h=d;return d=h.ref,{$$typeof:f,type:s,key:m,ref:d!==void 0?d:null,props:h}}return On.Fragment=u,On.jsx=c,On.jsxs=c,On}var Sd;function Sp(){return Sd||(Sd=1,hc.exports=xp()),hc.exports}var G=Sp(),gc={exports:{}},ut={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Td;function Tp(){if(Td)return ut;Td=1;var f=Symbol.for("react.transitional.element"),u=Symbol.for("react.portal"),c=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),d=Symbol.for("react.profiler"),h=Symbol.for("react.consumer"),m=Symbol.for("react.context"),S=Symbol.for("react.forward_ref"),y=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),T=Symbol.for("react.lazy"),M=Symbol.iterator;function z(b){return b===null||typeof b!="object"?null:(b=M&&b[M]||b["@@iterator"],typeof b=="function"?b:null)}var Y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},L=Object.assign,V={};function K(b,U,j){this.props=b,this.context=U,this.refs=V,this.updater=j||Y}K.prototype.isReactComponent={},K.prototype.setState=function(b,U){if(typeof b!="object"&&typeof b!="function"&&b!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,b,U,"setState")},K.prototype.forceUpdate=function(b){this.updater.enqueueForceUpdate(this,b,"forceUpdate")};function I(){}I.prototype=K.prototype;function ht(b,U,j){this.props=b,this.context=U,this.refs=V,this.updater=j||Y}var gt=ht.prototype=new I;gt.constructor=ht,L(gt,K.prototype),gt.isPureReactComponent=!0;var J=Array.isArray,B={H:null,A:null,T:null,S:null,V:null},nt=Object.prototype.hasOwnProperty;function et(b,U,j,C,$,yt){return j=yt.ref,{$$typeof:f,type:b,key:U,ref:j!==void 0?j:null,props:yt}}function P(b,U){return et(b.type,U,void 0,void 0,void 0,b.props)}function mt(b){return typeof b=="object"&&b!==null&&b.$$typeof===f}function vt(b){var U={"=":"=0",":":"=2"};return"$"+b.replace(/[=:]/g,function(j){return U[j]})}var dt=/\/+/g;function St(b,U){return typeof b=="object"&&b!==null&&b.key!=null?vt(""+b.key):U.toString(36)}function Q(){}function X(b){switch(b.status){case"fulfilled":return b.value;case"rejected":throw b.reason;default:switch(typeof b.status=="string"?b.then(Q,Q):(b.status="pending",b.then(function(U){b.status==="pending"&&(b.status="fulfilled",b.value=U)},function(U){b.status==="pending"&&(b.status="rejected",b.reason=U)})),b.status){case"fulfilled":return b.value;case"rejected":throw b.reason}}throw b}function ct(b,U,j,C,$){var yt=typeof b;(yt==="undefined"||yt==="boolean")&&(b=null);var at=!1;if(b===null)at=!0;else switch(yt){case"bigint":case"string":case"number":at=!0;break;case"object":switch(b.$$typeof){case f:case u:at=!0;break;case T:return at=b._init,ct(at(b._payload),U,j,C,$)}}if(at)return $=$(b),at=C===""?"."+St(b,0):C,J($)?(j="",at!=null&&(j=at.replace(dt,"$&/")+"/"),ct($,U,j,"",function($e){return $e})):$!=null&&(mt($)&&($=P($,j+($.key==null||b&&b.key===$.key?"":(""+$.key).replace(dt,"$&/")+"/")+at)),U.push($)),1;at=0;var ie=C===""?".":C+":";if(J(b))for(var _t=0;_t<b.length;_t++)C=b[_t],yt=ie+St(C,_t),at+=ct(C,U,j,yt,$);else if(_t=z(b),typeof _t=="function")for(b=_t.call(b),_t=0;!(C=b.next()).done;)C=C.value,yt=ie+St(C,_t++),at+=ct(C,U,j,yt,$);else if(yt==="object"){if(typeof b.then=="function")return ct(X(b),U,j,C,$);throw U=String(b),Error("Objects are not valid as a React child (found: "+(U==="[object Object]"?"object with keys {"+Object.keys(b).join(", ")+"}":U)+"). If you meant to render a collection of children, use an array instead.")}return at}function R(b,U,j){if(b==null)return b;var C=[],$=0;return ct(b,C,"","",function(yt){return U.call(j,yt,$++)}),C}function H(b){if(b._status===-1){var U=b._result;U=U(),U.then(function(j){(b._status===0||b._status===-1)&&(b._status=1,b._result=j)},function(j){(b._status===0||b._status===-1)&&(b._status=2,b._result=j)}),b._status===-1&&(b._status=0,b._result=U)}if(b._status===1)return b._result.default;throw b._result}var k=typeof reportError=="function"?reportError:function(b){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var U=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof b=="object"&&b!==null&&typeof b.message=="string"?String(b.message):String(b),error:b});if(!window.dispatchEvent(U))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",b);return}console.error(b)};function it(){}return ut.Children={map:R,forEach:function(b,U,j){R(b,function(){U.apply(this,arguments)},j)},count:function(b){var U=0;return R(b,function(){U++}),U},toArray:function(b){return R(b,function(U){return U})||[]},only:function(b){if(!mt(b))throw Error("React.Children.only expected to receive a single React element child.");return b}},ut.Component=K,ut.Fragment=c,ut.Profiler=d,ut.PureComponent=ht,ut.StrictMode=s,ut.Suspense=y,ut.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=B,ut.__COMPILER_RUNTIME={__proto__:null,c:function(b){return B.H.useMemoCache(b)}},ut.cache=function(b){return function(){return b.apply(null,arguments)}},ut.cloneElement=function(b,U,j){if(b==null)throw Error("The argument must be a React element, but you passed "+b+".");var C=L({},b.props),$=b.key,yt=void 0;if(U!=null)for(at in U.ref!==void 0&&(yt=void 0),U.key!==void 0&&($=""+U.key),U)!nt.call(U,at)||at==="key"||at==="__self"||at==="__source"||at==="ref"&&U.ref===void 0||(C[at]=U[at]);var at=arguments.length-2;if(at===1)C.children=j;else if(1<at){for(var ie=Array(at),_t=0;_t<at;_t++)ie[_t]=arguments[_t+2];C.children=ie}return et(b.type,$,void 0,void 0,yt,C)},ut.createContext=function(b){return b={$$typeof:m,_currentValue:b,_currentValue2:b,_threadCount:0,Provider:null,Consumer:null},b.Provider=b,b.Consumer={$$typeof:h,_context:b},b},ut.createElement=function(b,U,j){var C,$={},yt=null;if(U!=null)for(C in U.key!==void 0&&(yt=""+U.key),U)nt.call(U,C)&&C!=="key"&&C!=="__self"&&C!=="__source"&&($[C]=U[C]);var at=arguments.length-2;if(at===1)$.children=j;else if(1<at){for(var ie=Array(at),_t=0;_t<at;_t++)ie[_t]=arguments[_t+2];$.children=ie}if(b&&b.defaultProps)for(C in at=b.defaultProps,at)$[C]===void 0&&($[C]=at[C]);return et(b,yt,void 0,void 0,null,$)},ut.createRef=function(){return{current:null}},ut.forwardRef=function(b){return{$$typeof:S,render:b}},ut.isValidElement=mt,ut.lazy=function(b){return{$$typeof:T,_payload:{_status:-1,_result:b},_init:H}},ut.memo=function(b,U){return{$$typeof:g,type:b,compare:U===void 0?null:U}},ut.startTransition=function(b){var U=B.T,j={};B.T=j;try{var C=b(),$=B.S;$!==null&&$(j,C),typeof C=="object"&&C!==null&&typeof C.then=="function"&&C.then(it,k)}catch(yt){k(yt)}finally{B.T=U}},ut.unstable_useCacheRefresh=function(){return B.H.useCacheRefresh()},ut.use=function(b){return B.H.use(b)},ut.useActionState=function(b,U,j){return B.H.useActionState(b,U,j)},ut.useCallback=function(b,U){return B.H.useCallback(b,U)},ut.useContext=function(b){return B.H.useContext(b)},ut.useDebugValue=function(){},ut.useDeferredValue=function(b,U){return B.H.useDeferredValue(b,U)},ut.useEffect=function(b,U,j){var C=B.H;if(typeof j=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return C.useEffect(b,U)},ut.useId=function(){return B.H.useId()},ut.useImperativeHandle=function(b,U,j){return B.H.useImperativeHandle(b,U,j)},ut.useInsertionEffect=function(b,U){return B.H.useInsertionEffect(b,U)},ut.useLayoutEffect=function(b,U){return B.H.useLayoutEffect(b,U)},ut.useMemo=function(b,U){return B.H.useMemo(b,U)},ut.useOptimistic=function(b,U){return B.H.useOptimistic(b,U)},ut.useReducer=function(b,U,j){return B.H.useReducer(b,U,j)},ut.useRef=function(b){return B.H.useRef(b)},ut.useState=function(b){return B.H.useState(b)},ut.useSyncExternalStore=function(b,U,j){return B.H.useSyncExternalStore(b,U,j)},ut.useTransition=function(){return B.H.useTransition()},ut.version="19.1.0",ut}var Ed;function Ac(){return Ed||(Ed=1,gc.exports=Tp()),gc.exports}var Yt=Ac(),pc={exports:{}},An={},mc={exports:{}},yc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Od;function Ep(){return Od||(Od=1,function(f){function u(R,H){var k=R.length;R.push(H);t:for(;0<k;){var it=k-1>>>1,b=R[it];if(0<d(b,H))R[it]=H,R[k]=b,k=it;else break t}}function c(R){return R.length===0?null:R[0]}function s(R){if(R.length===0)return null;var H=R[0],k=R.pop();if(k!==H){R[0]=k;t:for(var it=0,b=R.length,U=b>>>1;it<U;){var j=2*(it+1)-1,C=R[j],$=j+1,yt=R[$];if(0>d(C,k))$<b&&0>d(yt,C)?(R[it]=yt,R[$]=k,it=$):(R[it]=C,R[j]=k,it=j);else if($<b&&0>d(yt,k))R[it]=yt,R[$]=k,it=$;else break t}}return H}function d(R,H){var k=R.sortIndex-H.sortIndex;return k!==0?k:R.id-H.id}if(f.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var h=performance;f.unstable_now=function(){return h.now()}}else{var m=Date,S=m.now();f.unstable_now=function(){return m.now()-S}}var y=[],g=[],T=1,M=null,z=3,Y=!1,L=!1,V=!1,K=!1,I=typeof setTimeout=="function"?setTimeout:null,ht=typeof clearTimeout=="function"?clearTimeout:null,gt=typeof setImmediate<"u"?setImmediate:null;function J(R){for(var H=c(g);H!==null;){if(H.callback===null)s(g);else if(H.startTime<=R)s(g),H.sortIndex=H.expirationTime,u(y,H);else break;H=c(g)}}function B(R){if(V=!1,J(R),!L)if(c(y)!==null)L=!0,nt||(nt=!0,St());else{var H=c(g);H!==null&&ct(B,H.startTime-R)}}var nt=!1,et=-1,P=5,mt=-1;function vt(){return K?!0:!(f.unstable_now()-mt<P)}function dt(){if(K=!1,nt){var R=f.unstable_now();mt=R;var H=!0;try{t:{L=!1,V&&(V=!1,ht(et),et=-1),Y=!0;var k=z;try{e:{for(J(R),M=c(y);M!==null&&!(M.expirationTime>R&&vt());){var it=M.callback;if(typeof it=="function"){M.callback=null,z=M.priorityLevel;var b=it(M.expirationTime<=R);if(R=f.unstable_now(),typeof b=="function"){M.callback=b,J(R),H=!0;break e}M===c(y)&&s(y),J(R)}else s(y);M=c(y)}if(M!==null)H=!0;else{var U=c(g);U!==null&&ct(B,U.startTime-R),H=!1}}break t}finally{M=null,z=k,Y=!1}H=void 0}}finally{H?St():nt=!1}}}var St;if(typeof gt=="function")St=function(){gt(dt)};else if(typeof MessageChannel<"u"){var Q=new MessageChannel,X=Q.port2;Q.port1.onmessage=dt,St=function(){X.postMessage(null)}}else St=function(){I(dt,0)};function ct(R,H){et=I(function(){R(f.unstable_now())},H)}f.unstable_IdlePriority=5,f.unstable_ImmediatePriority=1,f.unstable_LowPriority=4,f.unstable_NormalPriority=3,f.unstable_Profiling=null,f.unstable_UserBlockingPriority=2,f.unstable_cancelCallback=function(R){R.callback=null},f.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<R?Math.floor(1e3/R):5},f.unstable_getCurrentPriorityLevel=function(){return z},f.unstable_next=function(R){switch(z){case 1:case 2:case 3:var H=3;break;default:H=z}var k=z;z=H;try{return R()}finally{z=k}},f.unstable_requestPaint=function(){K=!0},f.unstable_runWithPriority=function(R,H){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var k=z;z=R;try{return H()}finally{z=k}},f.unstable_scheduleCallback=function(R,H,k){var it=f.unstable_now();switch(typeof k=="object"&&k!==null?(k=k.delay,k=typeof k=="number"&&0<k?it+k:it):k=it,R){case 1:var b=-1;break;case 2:b=250;break;case 5:b=1073741823;break;case 4:b=1e4;break;default:b=5e3}return b=k+b,R={id:T++,callback:H,priorityLevel:R,startTime:k,expirationTime:b,sortIndex:-1},k>it?(R.sortIndex=k,u(g,R),c(y)===null&&R===c(g)&&(V?(ht(et),et=-1):V=!0,ct(B,k-it))):(R.sortIndex=b,u(y,R),L||Y||(L=!0,nt||(nt=!0,St()))),R},f.unstable_shouldYield=vt,f.unstable_wrapCallback=function(R){var H=z;return function(){var k=z;z=H;try{return R.apply(this,arguments)}finally{z=k}}}}(yc)),yc}var Ad;function Op(){return Ad||(Ad=1,mc.exports=Ep()),mc.exports}var bc={exports:{}},Wt={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Nd;function Ap(){if(Nd)return Wt;Nd=1;var f=Ac();function u(y){var g="https://react.dev/errors/"+y;if(1<arguments.length){g+="?args[]="+encodeURIComponent(arguments[1]);for(var T=2;T<arguments.length;T++)g+="&args[]="+encodeURIComponent(arguments[T])}return"Minified React error #"+y+"; visit "+g+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function c(){}var s={d:{f:c,r:function(){throw Error(u(522))},D:c,C:c,L:c,m:c,X:c,S:c,M:c},p:0,findDOMNode:null},d=Symbol.for("react.portal");function h(y,g,T){var M=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:d,key:M==null?null:""+M,children:y,containerInfo:g,implementation:T}}var m=f.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function S(y,g){if(y==="font")return"";if(typeof g=="string")return g==="use-credentials"?g:""}return Wt.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,Wt.createPortal=function(y,g){var T=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!g||g.nodeType!==1&&g.nodeType!==9&&g.nodeType!==11)throw Error(u(299));return h(y,g,null,T)},Wt.flushSync=function(y){var g=m.T,T=s.p;try{if(m.T=null,s.p=2,y)return y()}finally{m.T=g,s.p=T,s.d.f()}},Wt.preconnect=function(y,g){typeof y=="string"&&(g?(g=g.crossOrigin,g=typeof g=="string"?g==="use-credentials"?g:"":void 0):g=null,s.d.C(y,g))},Wt.prefetchDNS=function(y){typeof y=="string"&&s.d.D(y)},Wt.preinit=function(y,g){if(typeof y=="string"&&g&&typeof g.as=="string"){var T=g.as,M=S(T,g.crossOrigin),z=typeof g.integrity=="string"?g.integrity:void 0,Y=typeof g.fetchPriority=="string"?g.fetchPriority:void 0;T==="style"?s.d.S(y,typeof g.precedence=="string"?g.precedence:void 0,{crossOrigin:M,integrity:z,fetchPriority:Y}):T==="script"&&s.d.X(y,{crossOrigin:M,integrity:z,fetchPriority:Y,nonce:typeof g.nonce=="string"?g.nonce:void 0})}},Wt.preinitModule=function(y,g){if(typeof y=="string")if(typeof g=="object"&&g!==null){if(g.as==null||g.as==="script"){var T=S(g.as,g.crossOrigin);s.d.M(y,{crossOrigin:T,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0})}}else g==null&&s.d.M(y)},Wt.preload=function(y,g){if(typeof y=="string"&&typeof g=="object"&&g!==null&&typeof g.as=="string"){var T=g.as,M=S(T,g.crossOrigin);s.d.L(y,T,{crossOrigin:M,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0,type:typeof g.type=="string"?g.type:void 0,fetchPriority:typeof g.fetchPriority=="string"?g.fetchPriority:void 0,referrerPolicy:typeof g.referrerPolicy=="string"?g.referrerPolicy:void 0,imageSrcSet:typeof g.imageSrcSet=="string"?g.imageSrcSet:void 0,imageSizes:typeof g.imageSizes=="string"?g.imageSizes:void 0,media:typeof g.media=="string"?g.media:void 0})}},Wt.preloadModule=function(y,g){if(typeof y=="string")if(g){var T=S(g.as,g.crossOrigin);s.d.m(y,{as:typeof g.as=="string"&&g.as!=="script"?g.as:void 0,crossOrigin:T,integrity:typeof g.integrity=="string"?g.integrity:void 0})}else s.d.m(y)},Wt.requestFormReset=function(y){s.d.r(y)},Wt.unstable_batchedUpdates=function(y,g){return y(g)},Wt.useFormState=function(y,g,T){return m.H.useFormState(y,g,T)},Wt.useFormStatus=function(){return m.H.useHostTransitionStatus()},Wt.version="19.1.0",Wt}var zd;function Np(){if(zd)return bc.exports;zd=1;function f(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(f)}catch(u){console.error(u)}}return f(),bc.exports=Ap(),bc.exports}/**
 * @license React
...
`}function _m(f,u="HR &amp; Legal trainings (in Dutch &amp; French)",c="Training",s="Day - Time",d="Format",h="Price ex VAT",m="https://www.securex.be/en/training-courses",S="Discover all our trainings"){return`
    <div pardot-repeatable="" class="">
      <table
        align="center"
        bgcolor="#ffffff"
...
`}function wm(f){return`
  ...
  `}function Mm(f,u="News from the sectors"){return`
                      <!--ARTICLE-->
                      <table
                        border="0"
                        cellpadding="0"
...
`}function Hm(f,u="Other news"){return`
                      <!--ARTICLE-->
                      <table
                        border="0"
                        cellpadding="0"
...
`}function Lm(){const[f,u]=Yt.useState(()=>Md.map(J=>({id:Nn(),...J,fieldsets:J.fieldsets.map(B=>({id:Nn(),...B}))}))),[c,s]=Yt.useState(""),[d,h]=Yt.useState(""),[m,S]=Yt.useState(!1),{i18n:y}=Ki(),[g,T]=Yt.useState({}),M=(J,B)=>{T(nt=>({...nt,[J]:B}))},z=J=>g[J]||Md.map(B=>({id:Nn(),...B,fieldsets:B.fieldsets.map(nt=>({id:Nn(),...nt}))}));Yt.useEffect(()=>{const J=y.language,B=z(J);u(B)},[y.language]),Yt.useEffect(()=>{const J=y.language;return()=>{M(J,f)}},[f]);const Y=J=>({id:Nn(),url:"#",title:"Lorem ipsum dolor",...J==="complex"&&{summary:"Lorem ipsum dolor, sit amet consectetur adipisicing elit. Explicabo aliquid ea repellendus, iure nihil soluta illum, asperiores labore rem molestiae similique maxime quaerat ab doloremque dicta, consequatur qui fugiat dolore.",cta:"CTA"},...J==="training"&&{date:"1 jan. 2025",time:"9:00 - 12:00",format:"On-Site in Brussels",price:"400"},...J==="simple"&&{subtitle:"Lorem ipsum dolor sit amet"}}),L=J=>{u(B=>B.map(nt=>{if(nt.id===J){const et=Y(nt.fieldsetType);return{...nt,fieldsets:[...nt.fieldsets,et]}}return nt}))},V=J=>{u(B=>B.map(nt=>{const et=nt.fieldsets.filter(P=>P.id!==J);return{...nt,fieldsets:et}}))},K=(J,B,nt)=>{u(et=>et.map(P=>{const mt=P.fieldsets.map(vt=>vt.id===J?typeof B=="string"?{...vt,[B]:nt}:{...vt,...B}:vt);return{...P,fieldsets:mt}}))},{t:I}=Ki(),ht=Yt.useMemo(()=>{const J=(B,nt=!1)=>{let et="";for(const Q of B)if(Q.title==="Featured News")for(let X=0;X<Q.fieldsets.length;X++)(X+1)%2!=0?et+=Am(Q.fieldsets[X].url,Q.fieldsets[X].title,Q.fieldsets[X].summary,Q.fieldsets[X].cta,I("alt"),nt?"./Securex_New_Lex4You.jpg":void 0):et+=Nm(Q.fieldsets[X].url,Q.fieldsets[X].title,Q.fieldsets[X].summary,Q.fieldsets[X].cta,I("alt"),nt?"./Securex_New_Lex4You.jpg":void 0);for(const Q of B)if(Q.title==="Euro Tip")for(let X=0;X<Q.fieldsets.length;X++)et+=zm(Q.fieldsets[X].url,Q.fieldsets[X].title,Q.fieldsets[X].summary,Q.fieldsets[X].cta,I("euroTipPreHeader"));for(const Q of B)if(Q.title==="HR Tip")for(let X=0;X<Q.fieldsets.length;X++)et+=Rm(Q.fieldsets[X].url,Q.fieldsets[X].title,Q.fieldsets[X].summary,Q.fieldsets[X].cta,I("HRTipPreHeader"));let P="";for(const Q of B)if(Q.title==="Trainings"&&Q.fieldsets.length>0){for(let X=0;X<Q.fieldsets.length;X++)P+=Dm(Q.fieldsets[X].url,Q.fieldsets[X].title,Q.fieldsets[X].date,Q.fieldsets[X].time,Q.fieldsets[X].format,Q.fieldsets[X].price);et+=_m(P,I("section_header"),I("th_training"),I("th_day_time"),I("th_format"),I("th_price_ex_vat"),I("section_cta_url"),I("section_cta_copy"))}let mt="",vt="",dt="";for(const Q of B){if(Q.title==="Sector News"&&Q.fieldsets.length>0){let X="";for(let ct=0;ct<Q.fieldsets.length;ct++)X+=Um(Q.fieldsets[ct].url,Q.fieldsets[ct].title,Q.fieldsets[ct].subtitle);vt+=Mm(X,I("sectorNewsHeader"))}if(Q.title==="Other News"&&Q.fieldsets.length>0){let X="";for(let ct=0;ct<Q.fieldsets.length;ct++)X+=Cm(Q.fieldsets[ct].url,Q.fieldsets[ct].title,Q.fieldsets[ct].subtitle);dt+=Hm(X,I("otherNewsHeader"))}}return mt=vt+dt,mt.length>0&&(et+=`${wm(mt)}`),`${Om(et,nt?"./Securex_Lex4You_logo.png":void 0,I("pre_header_copy"),I("view_online_copy"),I("img_link"),new Date().toLocaleDateString(y.language,{day:"numeric",month:"long",year:"numeric"}),I("tagline"),I("contact_link"),I("contact_copy"),I("disclaimer_link"),I("disclaimer_copy"),I("preferences_link"),I("preferences_copy"))}`};return{forPreview:J(f,!0),forCopy:J(f,!1)}},[f]),gt=()=>{d?navigator.clipboard.writeText(d).then(()=>{S(!0),setTimeout(()=>S(!1),2e3),console.log("HTML copied to clipboard!")}).catch(J=>{console.error("Failed to copy HTML: ",J)}):console.warn("No HTML content to copy.")};return Yt.useEffect(()=>{s(ht.forPreview),h(ht.forCopy)},[ht]),G.jsxs(G.Fragment,{children:[G.jsx(Kp,{title:"FlasHR",subtitle:"composer"}),G.jsxs("div",{className:"grid",children:[G.jsx(Ip,{sections:f,onAddFieldset:L,onRemove:V,onFieldChange:K}),G.jsx(tm,{html:c,onCopy:gt,isCopied:m})]})]})}_p.createRoot(document.getElementById("root")).render(G.jsxs(Yt.StrictMode,{children:[G.jsx("main",{className:"max-w-6xl mx-auto px-6 py-6",children:G.jsx(Lm,{})}),G.jsx("script",{type:"module",src:"./node_modules/flyonui/flyonui.js"})]}));
