 ...
 */var xd;function xp(){if(xd)return On;xd=1;var f=Symbol.for("react.transitional.element"),u=Symbol.for("react.fragment");function c(s,d,h){var m=null;if(h!==void 0&&(m=""+h),d.key!==void 0&&(m=""+d.key),"key"in d){h={};for(var S in d)S!=="key"&&(h[S]=d[S])}else h=d;return d=h.ref,{$$typeof:f,type:s,key:m,ref:d!==void 0?d:null,props:h}}return On.Fragment=u,On.jsx=c,On.jsxs=c,On}var Sd;function Sp(){return Sd||(Sd=1,hc.exports=xp()),hc.exports}var Z=Sp(),gc={exports:{}},ut={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Td;function Tp(){if(Td)return ut;Td=1;var f=Symbol.for("react.transitional.element"),u=Symbol.for("react.portal"),c=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),d=Symbol.for("react.profiler"),h=Symbol.for("react.consumer"),m=Symbol.for("react.context"),S=Symbol.for("react.forward_ref"),y=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),T=Symbol.for("react.lazy"),w=Symbol.iterator;function z(b){return b===null||typeof b!="object"?null:(b=w&&b[w]||b["@@iterator"],typeof b=="function"?b:null)}var Y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},L=Object.assign,V={};function Q(b,U,j){this.props=b,this.context=U,this.refs=V,this.updater=j||Y}Q.prototype.isReactComponent={},Q.prototype.setState=function(b,U){if(typeof b!="object"&&typeof b!="function"&&b!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,b,U,"setState")},Q.prototype.forceUpdate=function(b){this.updater.enqueueForceUpdate(this,b,"forceUpdate")};function I(){}I.prototype=Q.prototype;function ft(b,U,j){this.props=b,this.context=U,this.refs=V,this.updater=j||Y}var dt=ft.prototype=new I;dt.constructor=ft,L(dt,Q.prototype),dt.isPureReactComponent=!0;var K=Array.isArray,G={H:null,A:null,T:null,S:null,V:null},nt=Object.prototype.hasOwnProperty;function et(b,U,j,C,$,mt){return j=mt.ref,{$$typeof:f,type:b,key:U,ref:j!==void 0?j:null,props:mt}}function P(b,U){return et(b.type,U,void 0,void 0,void 0,b.props)}function pt(b){return typeof b=="object"&&b!==null&&b.$$typeof===f}function vt(b){var U={"=":"=0",":":"=2"};return"$"+b.replace(/[=:]/g,function(j){return U[j]})}var ht=/\/+/g;function B(b,U){return typeof b=="object"&&b!==null&&b.key!=null?vt(""+b.key):U.toString(36)}function k(){}function xt(b){switch(b.status){case"fulfilled":return b.value;case"rejected":throw b.reason;default:switch(typeof b.status=="string"?b.then(k,k):(b.status="pending",b.then(function(U){b.status==="pending"&&(b.status="fulfilled",b.value=U)},function(U){b.status==="pending"&&(b.status="rejected",b.reason=U)})),b.status){case"fulfilled":return b.value;case"rejected":throw b.reason}}throw b}function zt(b,U,j,C,$){var mt=typeof b;(mt==="undefined"||mt==="boolean")&&(b=null);var at=!1;if(b===null)at=!0;else switch(mt){case"bigint":case"string":case"number":at=!0;break;case"object":switch(b.$$typeof){case f:case u:at=!0;break;case T:return at=b._init,zt(at(b._payload),U,j,C,$)}}if(at)return $=$(b),at=C===""?"."+B(b,0):C,K($)?(j="",at!=null&&(j=at.replace(ht,"$&/")+"/"),zt($,U,j,"",function($e){return $e})):$!=null&&(pt($)&&($=P($,j+($.key==null||b&&b.key===$.key?"":(""+$.key).replace(ht,"$&/")+"/")+at)),U.push($)),1;at=0;var ie=C===""?".":C+":";if(K(b))for(var _t=0;_t<b.length;_t++)C=b[_t],mt=ie+B(C,_t),at+=zt(C,U,j,mt,$);else if(_t=z(b),typeof _t=="function")for(b=_t.call(b),_t=0;!(C=b.next()).done;)C=C.value,mt=ie+B(C,_t++),at+=zt(C,U,j,mt,$);else if(mt==="object"){if(typeof b.then=="function")return zt(xt(b),U,j,C,$);throw U=String(b),Error("Objects are not valid as a React child (found: "+(U==="[object Object]"?"object with keys {"+Object.keys(b).join(", ")+"}":U)+"). If you meant to render a collection of children, use an array instead.")}return at}function R(b,U,j){if(b==null)return b;var C=[],$=0;return zt(b,C,"","",function(mt){return U.call(j,mt,$++)}),C}function H(b){if(b._status===-1){var U=b._result;U=U(),U.then(function(j){(b._status===0||b._status===-1)&&(b._status=1,b._result=j)},function(j){(b._status===0||b._status===-1)&&(b._status=2,b._result=j)}),b._status===-1&&(b._status=0,b._result=U)}if(b._status===1)return b._result.default;throw b._result}var J=typeof reportError=="function"?reportError:function(b){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var U=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof b=="object"&&b!==null&&typeof b.message=="string"?String(b.message):String(b),error:b});if(!window.dispatchEvent(U))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",b);return}console.error(b)};function it(){}return ut.Children={map:R,forEach:function(b,U,j){R(b,function(){U.apply(this,arguments)},j)},count:function(b){var U=0;return R(b,function(){U++}),U},toArray:function(b){return R(b,function(U){return U})||[]},only:function(b){if(!pt(b))throw Error("React.Children.only expected to receive a single React element child.");return b}},ut.Component=Q,ut.Fragment=c,ut.Profiler=d,ut.PureComponent=ft,ut.StrictMode=s,ut.Suspense=y,ut.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=G,ut.__COMPILER_RUNTIME={__proto__:null,c:function(b){return G.H.useMemoCache(b)}},ut.cache=function(b){return function(){return b.apply(null,arguments)}},ut.cloneElement=function(b,U,j){if(b==null)throw Error("The argument must be a React element, but you passed "+b+".");var C=L({},b.props),$=b.key,mt=void 0;if(U!=null)for(at in U.ref!==void 0&&(mt=void 0),U.key!==void 0&&($=""+U.key),U)!nt.call(U,at)||at==="key"||at==="__self"||at==="__source"||at==="ref"&&U.ref===void 0||(C[at]=U[at]);var at=arguments.length-2;if(at===1)C.children=j;else if(1<at){for(var ie=Array(at),_t=0;_t<at;_t++)ie[_t]=arguments[_t+2];C.children=ie}return et(b.type,$,void 0,void 0,mt,C)},ut.createContext=function(b){return b={$$typeof:m,_currentValue:b,_currentValue2:b,_threadCount:0,Provider:null,Consumer:null},b.Provider=b,b.Consumer={$$typeof:h,_context:b},b},ut.createElement=function(b,U,j){var C,$={},mt=null;if(U!=null)for(C in U.key!==void 0&&(mt=""+U.key),U)nt.call(U,C)&&C!=="key"&&C!=="__self"&&C!=="__source"&&($[C]=U[C]);var at=arguments.length-2;if(at===1)$.children=j;else if(1<at){for(var ie=Array(at),_t=0;_t<at;_t++)ie[_t]=arguments[_t+2];$.children=ie}if(b&&b.defaultProps)for(C in at=b.defaultProps,at)$[C]===void 0&&($[C]=at[C]);return et(b,mt,void 0,void 0,null,$)},ut.createRef=function(){return{current:null}},ut.forwardRef=function(b){return{$$typeof:S,render:b}},ut.isValidElement=pt,ut.lazy=function(b){return{$$typeof:T,_payload:{_status:-1,_result:b},_init:H}},ut.memo=function(b,U){return{$$typeof:g,type:b,compare:U===void 0?null:U}},ut.startTransition=function(b){var U=G.T,j={};G.T=j;try{var C=b(),$=G.S;$!==null&&$(j,C),typeof C=="object"&&C!==null&&typeof C.then=="function"&&C.then(it,J)}catch(mt){J(mt)}finally{G.T=U}},ut.unstable_useCacheRefresh=function(){return G.H.useCacheRefresh()},ut.use=function(b){return G.H.use(b)},ut.useActionState=function(b,U,j){return G.H.useActionState(b,U,j)},ut.useCallback=function(b,U){return G.H.useCallback(b,U)},ut.useContext=function(b){return G.H.useContext(b)},ut.useDebugValue=function(){},ut.useDeferredValue=function(b,U){return G.H.useDeferredValue(b,U)},ut.useEffect=function(b,U,j){var C=G.H;if(typeof j=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return C.useEffect(b,U)},ut.useId=function(){return G.H.useId()},ut.useImperativeHandle=function(b,U,j){return G.H.useImperativeHandle(b,U,j)},ut.useInsertionEffect=function(b,U){return G.H.useInsertionEffect(b,U)},ut.useLayoutEffect=function(b,U){return G.H.useLayoutEffect(b,U)},ut.useMemo=function(b,U){return G.H.useMemo(b,U)},ut.useOptimistic=function(b,U){return G.H.useOptimistic(b,U)},ut.useReducer=function(b,U,j){return G.H.useReducer(b,U,j)},ut.useRef=function(b){return G.H.useRef(b)},ut.useState=function(b){return G.H.useState(b)},ut.useSyncExternalStore=function(b,U,j){return G.H.useSyncExternalStore(b,U,j)},ut.useTransition=function(){return G.H.useTransition()},ut.version="19.1.0",ut}var Ed;function Ac(){return Ed||(Ed=1,gc.exports=Tp()),gc.exports}var Yt=Ac(),pc={exports:{}},An={},mc={exports:{}},yc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Od;function Ep(){return Od||(Od=1,function(f){function u(R,H){var J=R.length;R.push(H);t:for(;0<J;){var it=J-1>>>1,b=R[it];if(0<d(b,H))R[it]=H,R[J]=b,J=it;else break t}}function c(R){return R.length===0?null:R[0]}function s(R){if(R.length===0)return null;var H=R[0],J=R.pop();if(J!==H){R[0]=J;t:for(var it=0,b=R.length,U=b>>>1;it<U;){var j=2*(it+1)-1,C=R[j],$=j+1,mt=R[$];if(0>d(C,J))$<b&&0>d(mt,C)?(R[it]=mt,R[$]=J,it=$):(R[it]=C,R[j]=J,it=j);else if($<b&&0>d(mt,J))R[it]=mt,R[$]=J,it=$;else break t}}return H}function d(R,H){var J=R.sortIndex-H.sortIndex;return J!==0?J:R.id-H.id}if(f.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var h=performance;f.unstable_now=function(){return h.now()}}else{var m=Date,S=m.now();f.unstable_now=function(){return m.now()-S}}var y=[],g=[],T=1,w=null,z=3,Y=!1,L=!1,V=!1,Q=!1,I=typeof setTimeout=="function"?setTimeout:null,ft=typeof clearTimeout=="function"?clearTimeout:null,dt=typeof setImmediate<"u"?setImmediate:null;function K(R){for(var H=c(g);H!==null;){if(H.callback===null)s(g);else if(H.startTime<=R)s(g),H.sortIndex=H.expirationTime,u(y,H);else break;H=c(g)}}function G(R){if(V=!1,K(R),!L)if(c(y)!==null)L=!0,nt||(nt=!0,B());else{var H=c(g);H!==null&&zt(G,H.startTime-R)}}var nt=!1,et=-1,P=5,pt=-1;function vt(){return Q?!0:!(f.unstable_now()-pt<P)}function ht(){if(Q=!1,nt){var R=f.unstable_now();pt=R;var H=!0;try{t:{L=!1,V&&(V=!1,ft(et),et=-1),Y=!0;var J=z;try{e:{for(K(R),w=c(y);w!==null&&!(w.expirationTime>R&&vt());){var it=w.callback;if(typeof it=="function"){w.callback=null,z=w.priorityLevel;var b=it(w.expirationTime<=R);if(R=f.unstable_now(),typeof b=="function"){w.callback=b,K(R),H=!0;break e}w===c(y)&&s(y),K(R)}else s(y);w=c(y)}if(w!==null)H=!0;else{var U=c(g);U!==null&&zt(G,U.startTime-R),H=!1}}break t}finally{w=null,z=J,Y=!1}H=void 0}}finally{H?B():nt=!1}}}var B;if(typeof dt=="function")B=function(){dt(ht)};else if(typeof MessageChannel<"u"){var k=new MessageChannel,xt=k.port2;k.port1.onmessage=ht,B=function(){xt.postMessage(null)}}else B=function(){I(ht,0)};function zt(R,H){et=I(function(){R(f.unstable_now())},H)}f.unstable_IdlePriority=5,f.unstable_ImmediatePriority=1,f.unstable_LowPriority=4,f.unstable_NormalPriority=3,f.unstable_Profiling=null,f.unstable_UserBlockingPriority=2,f.unstable_cancelCallback=function(R){R.callback=null},f.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<R?Math.floor(1e3/R):5},f.unstable_getCurrentPriorityLevel=function(){return z},f.unstable_next=function(R){switch(z){case 1:case 2:case 3:var H=3;break;default:H=z}var J=z;z=H;try{return R()}finally{z=J}},f.unstable_requestPaint=function(){Q=!0},f.unstable_runWithPriority=function(R,H){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var J=z;z=R;try{return H()}finally{z=J}},f.unstable_scheduleCallback=function(R,H,J){var it=f.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?it+J:it):J=it,R){case 1:var b=-1;break;case 2:b=250;break;case 5:b=1073741823;break;case 4:b=1e4;break;default:b=5e3}return b=J+b,R={id:T++,callback:H,priorityLevel:R,startTime:J,expirationTime:b,sortIndex:-1},J>it?(R.sortIndex=J,u(g,R),c(y)===null&&R===c(g)&&(V?(ft(et),et=-1):V=!0,zt(G,J-it))):(R.sortIndex=b,u(y,R),L||Y||(L=!0,nt||(nt=!0,B()))),R},f.unstable_shouldYield=vt,f.unstable_wrapCallback=function(R){var H=z;return function(){var J=z;z=H;try{return R.apply(this,arguments)}finally{z=J}}}}(yc)),yc}var Ad;function Op(){return Ad||(Ad=1,mc.exports=Ep()),mc.exports}var bc={exports:{}},Wt={};/**
 * @license React
...
`}function _m(f="https://www.securex.be/en/lex4you/employer",u="Lorem ipsum dolor",c="1 jan. 2025",s="9:00 - 12:00",d="Online",h="400",m="HR &amp; Legal trainings (in Dutch &amp; French)",S="Training",y="Day - Time",g="Format",T="Price ex VAT",w="https://www.securex.be/en/training-courses",z="Discover all our trainings"){return`
    <div pardot-repeatable="" class="">
      <table
        align="center"
        bgcolor="#ffffff"
...
`}function Cm(){const[f,u]=Yt.useState(()=>Md.map(K=>({id:Nn(),...K,fieldsets:K.fieldsets.map(G=>({id:Nn(),...G}))}))),[c,s]=Yt.useState(""),[d,h]=Yt.useState(""),[m,S]=Yt.useState(!1),{i18n:y}=Ki(),[g,T]=Yt.useState({}),w=(K,G)=>{T(nt=>({...nt,[K]:G}))},z=K=>g[K]||Md.map(G=>({id:Nn(),...G,fieldsets:G.fieldsets.map(nt=>({id:Nn(),...nt}))}));Yt.useEffect(()=>{const K=y.language,G=z(K);u(G)},[y.language]),Yt.useEffect(()=>{const K=y.language;return()=>{w(K,f)}},[f]);const Y=K=>({id:Nn(),url:"#",title:"Lorem ipsum dolor",...K==="complex"&&{summary:"Lorem ipsum dolor, sit amet consectetur adipisicing elit. Explicabo aliquid ea repellendus, iure nihil soluta illum, asperiores labore rem molestiae similique maxime quaerat ab doloremque dicta, consequatur qui fugiat dolore.",cta:"CTA"},...K==="training"&&{date:"1 jan. 2025",time:"9:00 - 12:00",format:"On-Site in Brussels",price:"400"},...K==="simple"&&{subtitle:"Lorem ipsum dolor sit amet"}}),L=K=>{u(G=>G.map(nt=>{if(nt.id===K){const et=Y(nt.fieldsetType);return{...nt,fieldsets:[...nt.fieldsets,et]}}return nt}))},V=K=>{u(G=>G.map(nt=>{const et=nt.fieldsets.filter(P=>P.id!==K);return{...nt,fieldsets:et}}))},Q=(K,G,nt)=>{u(et=>et.map(P=>{const pt=P.fieldsets.map(vt=>vt.id===K?{...vt,[G]:nt}:vt);return{...P,fieldsets:pt}}))},{t:I}=Ki(),ft=Yt.useMemo(()=>{const K=(G,nt=!1)=>{let et="";for(const B of G)if(B.title==="Featured News")for(let k=0;k<B.fieldsets.length;k++)(k+1)%2!=0?et+=Am(B.fieldsets[k].url,B.fieldsets[k].title,B.fieldsets[k].summary,B.fieldsets[k].cta,I("alt"),nt?"./Securex_New_Lex4You.jpg":void 0):et+=Nm(B.fieldsets[k].url,B.fieldsets[k].title,B.fieldsets[k].summary,B.fieldsets[k].cta,I("alt"),nt?"./Securex_New_Lex4You.jpg":void 0);for(const B of G)if(B.title==="Euro Tip")for(let k=0;k<B.fieldsets.length;k++)et+=zm(B.fieldsets[k].url,B.fieldsets[k].title,B.fieldsets[k].summary,B.fieldsets[k].cta,I("euroTipPreHeader"));for(const B of G)if(B.title==="HR Tip")for(let k=0;k<B.fieldsets.length;k++)et+=Rm(B.fieldsets[k].url,B.fieldsets[k].title,B.fieldsets[k].summary,B.fieldsets[k].cta,I("HRTipPreHeader"));for(const B of G)if(B.title==="Trainings")for(let k=0;k<B.fieldsets.length;k++)et+=_m(B.fieldsets[k].url,B.fieldsets[k].title,B.fieldsets[k].date,B.fieldsets[k].time,B.fieldsets[k].format,B.fieldsets[k].price,I("section_header"),I("th_training"),I("th_day_time"),I("th_format"),I("th_price_ex_vat"),I("section_cta_url"),I("section_cta_copy"));let P="",pt="",vt="";for(const B of G){if(B.title==="Sector News"){let k="";for(let xt=0;xt<B.fieldsets.length;xt++)k+=Mm(B.fieldsets[xt].url,B.fieldsets[xt].title,B.fieldsets[xt].subtitle);pt+=wm(k,I("sectorNewsHeader"))}if(B.title==="Other News"){let k="";for(let xt=0;xt<B.fieldsets.length;xt++)k+=Hm(B.fieldsets[xt].url,B.fieldsets[xt].title,B.fieldsets[xt].subtitle);vt+=Um(k,I("otherNewsHeader"))}}return P=pt+vt,et+=`${Dm(P)}`,`${Om(et,nt?"./Securex_Lex4You_logo.png":void 0,I("pre_header_copy"),I("view_online_copy"),I("img_link"),new Date().toLocaleDateString(y.language,{day:"numeric",month:"long",year:"numeric"}),I("tagline"),I("contact_link"),I("contact_copy"),I("disclaimer_link"),I("disclaimer_copy"),I("preferences_link"),I("preferences_copy"))}`};return{forPreview:K(f,!0),forCopy:K(f,!1)}},[f]),dt=()=>{d?navigator.clipboard.writeText(d).then(()=>{S(!0),setTimeout(()=>S(!1),2e3),console.log("HTML copied to clipboard!")}).catch(K=>{console.error("Failed to copy HTML: ",K)}):console.warn("No HTML content to copy.")};return Yt.useEffect(()=>{s(ft.forPreview),h(ft.forCopy)},[ft]),Z.jsxs(Z.Fragment,{children:[Z.jsx(Kp,{title:"FlasHR",subtitle:"composer"}),Z.jsxs("div",{className:"grid",children:[Z.jsx(Ip,{sections:f,onAddFieldset:L,onRemove:V,onFieldChange:Q}),Z.jsx(tm,{html:c,onCopy:dt,isCopied:m})]})]})}_p.createRoot(document.getElementById("root")).render(Z.jsxs(Yt.StrictMode,{children:[Z.jsx("main",{className:"max-w-6xl mx-auto px-6 py-6",children:Z.jsx(Cm,{})}),Z.jsx("script",{type:"module",src:"./node_modules/flyonui/flyonui.js"})]}));
